# -*- encoding: utf-8 -*-
# stub: cocoapods 1.12.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.12.1"])
    s.add_runtime_dependency(%q<claide>.freeze, [">= 1.0.2", "< 2.0"])
    s.add_runtime_dependency(%q<cocoapods-deintegrate>.freeze, [">= 1.0.3", "< 2.0"])
    s.add_runtime_dependency(%q<cocoapods-downloader>.freeze, [">= 1.6.0", "< 2.0"])
    ...
    s.add_dependency(%q<cocoapods-core>.freeze, ["= 1.12.1"])
    s.add_dependency(%q<claide>.freeze, [">= 1.0.2", "< 2.0"])
    s.add_dependency(%q<cocoapods-deintegrate>.freeze, [">= 1.0.3", "< 2.0"])
    s.add_dependency(%q<cocoapods-downloader>.freeze, [">= 1.6.0", "< 2.0"])
